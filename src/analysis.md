...
В shell help и автодополнение должны читать Command Catalog, а динамические значения - API. Разбирать локализованный вывод нельзя.
...
shell, а абсолютный `/diag help` - к C-модулю.
